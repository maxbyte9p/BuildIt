...
pkg=stage3-glibc
src=glibc-2.36.tar.xz
patch=glibc-2.36-fhs-1.patch
...
install:V: build
	...
	tar -xf $SOURCES/tzdata2022c.tar.gz
	...
	echo $ld_so_conf > /etc/ld.so.conf
	

##runchroot make check -C /build/$pkg/build